...
def statistical_comparison(x,p1,p2,warning=False):
    ...
    print("------------------------------------------------------------------")
    #print("Chi^2 \t\t\t | {:6.5e} | {:6.5e} | {:6.5e}".format(chisquare(p1,p2)[0],chisquare(low_p1,low_p2)[0],chisquare(high_p1,high_p2)[0]))
    ...
    #print("Area between curves \t | {:6.5e} | {:6.5e} | {:6.5e}".format(area_between_curves(p1,p2),area_between_curves(low_p1,low_p2),area_between_curves(high_p1,high_p2)))
    '''
    # For latex output
    print("")
    print("Statistical comparison")
    ...
    print("------------------------------------------------------------------")
    #print("Chi^2 \t\t\t | {:6.5e} | {:6.5e} | {:6.5e}".format(chisquare(p1,p2)[0],chisquare(low_p1,low_p2)[0],chisquare(high_p1,high_p2)[0]))
    print("R factor \t\t | {:1.2f} & {:1.2f} & {:1.2f}".format(R_Factor(p1,p2),R_Factor(low_p1,low_p2),R_Factor(high_p1,high_p2)))
    print("Weighted R factor \t | {:1.2f} & {:1.2f} & {:1.2f}".format(R_Factor(p1,p2,weighted=True),R_Factor(low_p1,low_p2,weighted=True),R_Factor(high_p1,high_p2,weighted=True)))
    print("Similarity index \t | {:1.2f} & {:1.2f} & {:1.2f}".format(similarity_index(p1,p2),similarity_index(low_p1,low_p2),similarity_index(high_p1,high_p2)))
    #print("Area between curves \t | {:6.5e} | {:6.5e} | {:6.5e}".format(area_between_curves(p1,p2),area_between_curves(low_p1,low_p2),area_between_curves(high_p1,high_p2)))
    '''
